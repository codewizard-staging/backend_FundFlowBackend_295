...
@Entity(name = "Startup")
@Table(name = "\"Startup\"", schema =  "\"fundflowbackend61\"")
@Data
...
@Column(name = "\"KeyMetrics\"")
    ...
    @CollectionTable(schema = "\"fundflowbackend61\"", name = "\"StartupKeyMetrics\"",joinColumns = @JoinColumn(name = "\"SId\""))
...
@JoinTable(
            ...
            inverseJoinColumns = @JoinColumn( name="\"FId\""), schema = "\"fundflowbackend61\"")
...
@JoinTable(
            ...
            joinColumns = @JoinColumn( name="\"SId\""),
            inverseJoinColumns = @JoinColumn( name="\"RoundId\""), schema = "\"fundflowbackend61\"")
